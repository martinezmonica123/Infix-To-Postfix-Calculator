 ...
 * 
 * Based on an implementation found at (http://horstmann.com/corejava)
 * This Calculator program modifies the original implementation
 * in order to convert infix expressions to post-fix expression and 
 * to evaluate post-fix expression.
 * 
 *
 */
